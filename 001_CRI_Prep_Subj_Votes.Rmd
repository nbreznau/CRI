...
The third file "votes.dta" was generated in the CRI work-up. See CRI_Spec_Analysis.Rmd.
...
agg_png(file = "results/Fig1_meta.png", width = 750)
...
dev.off()
knitr::include_graphics("results/Fig1_meta.png")
```
