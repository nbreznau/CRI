...
```{r fig1_test}
testlabs <- c("Test: Stock", "Test: Flow", "Test: Change Flow")
#g7 <- 
  ggplot(crispectest) +
...
```{r fig1_measure}
# set labels
dvlabs = c("DV: Jobs","DV: Unemp","DV: IncDiff","DV: OldAge","DV: House","DV: Health","DV: Scale")
...
```{r fig1_sample}
samplabs <- c("1996 & 2006","2006 & 2016","1996, 2006 & 2016","Other")
