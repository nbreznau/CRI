...
g5a_new <- 
  ggplot(cri_team) +
  geom_point(aes(x = count2, y = AME_Zt, color = subj_concl), shape = 18, size = 6) +   scale_color_manual(values = c("firebrick","grey55", "chartreuse4"), labels = c("Rejected","Not testable","Supported")) +
