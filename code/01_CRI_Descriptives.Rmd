...
```{r load, warning=FALSE,message=FALSE, include =F}
...
```{r descriptive1, warning = F, message = F, include=FALSE}
kable_styling(t2) %>%
...
This file is part of [https://github.com/nbreznau/CRI](https://github.com/nbreznau/CRI), the reproduction materials for [*The Crowdsourced Replication Initiative: Investigating Immigration and Social Policy Preferences*](https://doi.org/10.31235/osf.io/6j9qb).
