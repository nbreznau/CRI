...
g3 <- 
  ...
  scale_x_discrete(breaks = c(1,2,3,4),
                   labels = c("Prior\nbeliefs","Prior\nattitudes","Topical\nexpertise","Method-\nological\nexpertise")) +
  ylab("Average AME\n(between-team variance)") +
  stat_cor(aes(x = belief_ipred, y = AME_Z_int), r.digits = 3, r.accuracy = 0.01, p.accuracy = 0.01, label.x = 1.15, label.y = -0.02, size = 2.5, data = cri_team_groups1) +
  stat_cor(aes(x = pro_immigrant, y = AME_Z_int), r.digits = 3, r.accuracy = 0.01, p.accuracy = 0.01, label.x = 2.15, label.y = -0.02, size = 2.5, data = cri_team_groups2) +
  stat_cor(aes(x = stats_ipred, y = AME_Z_int), r.digits = 3, r.accuracy = 0.01, p.accuracy = 0.01, label.x = 3.15, label.y = -0.02, size = 2.5, data = cri_team_groups2) +
  stat_cor(aes(x = topic_ipred, y = AME_Z_int), r.digits = 3, r.accuracy = 0.01, p.accuracy = 0.01, label.x = 4.15, label.y = -0.02, size = 2.5, data = cri_team_groups2) +
...
g4 <- ggplot(cri_team_g, aes(x = group, y = AME_Z_var)) +
  ...
  stat_cor(aes(x = belief_ipred, y = AME_Z_var), r.digits = 3, r.accuracy = 0.01, p.accuracy = 0.01, label.x = 1.15, label.y = 1, size = 2.5, data = cri_team_groups1) +
  stat_cor(aes(x = pro_immigrant, y = AME_Z_var), r.digits = 3, r.accuracy = 0.01, p.accuracy = 0.01, label.x = 2.15, label.y = 1, size = 2.5, data = cri_team_groups2) +
  stat_cor(aes(x = stats_ipred, y = AME_Z_var), r.digits = 3, r.accuracy = 0.01, p.accuracy = 0.01, label.x = 3.15, label.y = 1, size = 2.5, data = cri_team_groups2) +
  stat_cor(aes(x = topic_ipred, y = AME_Z_var), r.digits = 3, r.accuracy = 0.01, p.accuracy = 0.01, label.x = 4.15, label.y = 1, size = 2.5, data = cri_team_groups2) +
  scale_colour_manual(values = c("#E6AB02","#7570B3"), breaks = c(0,1),
                   labels = c("Higher","Lower"), name = "") +
  scale_fill_manual(values = c("#E6AB02","#7570B3"), breaks = c(0,1),
                   labels = c("Higher","Lower"), name = "", expand = c(0, 0)) +
...
```{r combine2pnas}
agg_tiff(filename = here::here("results/Fig2.tiff"), width = 1000, height = 800, res = 144)
ggarrange(g3,g4) 
dev.off()
