...
cri_ml <- read.csv(file = "results/cri_ml.csv", header = T)
...
sjPlot::tab_model(m_dredged, digits = 3, p.style = "stars", show.ci = F, show.loglik = T, show.aic = T, file = "results/reg_dredge.htm")

m_d_out_v <- as.data.frame(VarCorr(m_dredged))

m_d_out <- as.data.frame(read_html("results/reg_dredge.htm") %>% html_table(fill=TRUE))
...
# Save table
write.csv(m_d_out, file = "results/TblS10_dredge.csv")
```
