...
## Team Level
m_d_out_f[35,2:length(m_d_out_f[1,])] <- round(as.numeric(c(md_1[1,4],md_2[1,4],md_3[1,4],md_4[1,4],
                    md_5[1,4],md_6[1,4])),6)

## Model Level
m_d_out_f[36,2:length(m_d_out_f[1,])] <- round(as.numeric(c(md_1[2,4],md_2[2,4],md_3[2,4],
