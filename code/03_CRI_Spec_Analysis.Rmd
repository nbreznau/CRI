...
g1a <- ggplot(crispectest) +
  ...
  scale_color_manual(values = c("#66A61E","grey55", "#7570B3"), labels = c("Negative","Not sig.","Positive"," ")) +
  ylim(-0.21, 0.21) +
  labs(color = "Effect at 95%CI", x = "by Standardized Effect Size", y = " \n \n \n ") +
  theme_classic() +
  guides(color = guide_legend(override.aes = list(size=7, color=c("#66A61E","grey55", "#7570B3","NA")))) +
  theme(
    legend.position = "none",
