...
ggplot(crispectest) +
  ...
  #ylim(-1.8, 1.8) +
  annotate(geom = "text", x = 150, y = 0.5, label = "NEGATIVE, 95% CI", color = "#66A61E", fontface = "bold", hjust = 0, size = 3) +
  annotate(geom = "text", x = 800, y = 1, label = "POSITIVE, 95% CI", color = "#D95F02", fontface = "bold", hjust = 0, size = 3) +
  annotate(geom = "text", x = 450, y = -0.6, label = "NOT STAT. SIGNIFICANT, 95% CI", fontface = 3, color = "grey55", hjust = 0, size = 2.5) +
  ...
  labs(color = "Effect at 95% CI", x = "Models Ordered by AME", y = "Average Margina Effect (AME)") +
...
g5a_new <- 
  ggplot(cri_team) +
  geom_point(aes(x = count2, y = AME_Zt, color = subj_concl), shape = 18, size = 4) +   scale_color_manual(values = c("#D95F02", "grey55", "#66A61E"), labels = c("Rejected","Not testable","Supported")) +
