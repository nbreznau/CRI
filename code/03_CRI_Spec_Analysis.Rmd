...
ggplot(crispectest) +
  ...
  #ylim(-1.8, 1.8) +
  annotate(geom = "text", x = 340, y = 1.45, label = "NEGATIVE (95% CI)", color = "#66A61E", fontface = "bold", size = 3) +
  annotate(geom = "text", x = 940, y = 1.45, label = "POSITIVE (95% CI)", color = "#D95F02", fontface = "bold", size = 3) +
  ...
  geom_point(aes(x=340, y=-2), data=dat, size=18, shape=1, color="#66A61E") +
  geom_point(aes(x=640, y=-2), data=dat, size=26, shape=1, color="grey55") +
  geom_point(aes(x=940, y=-2), data=dat, size=14, shape=1, color="#D95F02") +
  annotate("text", x=340, y=-2, label = paste(sig_neg), color="#66A61E", fontface = "bold") +
  annotate("text", x=640, y=-2, label = paste(ns), color="grey55", fontface = "bold") +
  annotate("text", x=940, y=-2, label = paste(sig_pos), color="#D95F02", fontface = "bold") +
