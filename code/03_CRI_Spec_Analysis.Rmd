...
g1 <- ggplot(crispectest) +
  ...
  scale_color_manual(values = c("#66A61E","grey55", "#D95F02"), labels = c("Negative","Not sig.","Positive"," ")) +
  ylim(-0.21, 0.21) +
...
g5a_new <- 
  ggplot(cri_team) +
  geom_point(aes(x = count2, y = AME_Zt, color = subj_concl), shape = 18, size = 4) +   scale_color_manual(values = c("#66A61E","grey55", "#D95F02"), labels = c("Rejected","Not testable","Supported")) +
