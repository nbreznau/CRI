...
ggplot(crispectest) +
  ...
  #ylim(-1.8, 1.8) +
  annotate(geom = "text", x = 340, y = 1.45, label = "NEGATIVE", color = "#66A61E", fontface = "bold", size = 3) +
  annotate(geom = "text", x = 940, y = 1.45, label = "POSITIVE", color = "#D95F02", fontface = "bold", size = 3) +
