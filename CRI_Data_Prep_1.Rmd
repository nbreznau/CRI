...
cri_str <- read_excel(wdir("CRI Model Specifications and Margins.xlsx"), sheet = "Data")
...
write.csv(cri, file = wdir("cri.csv"), row.names = F)
write.csv(cri_str, file = wdir("cri_str.csv"), row.names = F)
write.csv(cri_team, file = wdir("cri_team.csv"), row.names = F)
```
