---
title: "Subjective Model Scoring"
output:
  html_document:
    df_print: paged
---
...
pacman::p_load("readstata13","xlsx","dplyr","tidyverse","ggplot2","kableExtra","fastDummies","xlsx","ragg")
...
```{r load}
model_desc <- read.xlsx(here::here("data","Research Design Votes.xlsx"), sheetName = "RD Paragraph Output", header = T, stringsAsFactors = F)
crispec <- read.xlsx(here::here("data","CRI Model Specifications and Margins.xlsx"), sheetName = "Data")
# sometimes this imports extra rows becasue of the xlsx format, remove if so
