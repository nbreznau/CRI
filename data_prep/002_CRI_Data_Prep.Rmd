...
In the folder **/CRI/CRI_shiny** we deploy a 'shiny app' to allow users to interact with the results by model specification types. This code preps the data. The app uses the rdfpackage by Gassen which requires discrete choice variables.
