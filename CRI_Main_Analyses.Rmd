...
agg_png(file = wdir("Fig2_Popular.png"), width = 800, height = 500, res = 144)
print(plot_rdf_spec_curve(df3, "est", "lb", "ub", est_color = "grey", est_color_signeg = "red",  choice_ind_point = F, lower_to_upper = 1.75, est_label = "Standardized \nMarginal Effect", ribbon = F))
dev.off()
...
agg_png(file = wdir("Fig4_Rain.png"), height = 360, width = 440, scaling = .4, res = 144)
rain2
dev.off()
