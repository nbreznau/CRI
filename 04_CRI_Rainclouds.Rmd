...
pacman::p_load("ggplot2","dplyr","readr","plotscale","lattice","tidyr","jtools","sjPlot","sjmisc","sjlabelled","knitr","cowplot")
...
fig4 <- ggplot(cri_team_combine, aes(x=belief_cat_factor, y=AME_Zt, fill = iv_type2))+
  ...
  ylab('Avg. Marginal Effect')+xlab('Belief that H is True by Researcher/Team')+
  ylim(-0.12,0.12)+
  coord_flip()+guides(fill = FALSE)+
  scale_colour_brewer(palette = "Dark2")+
  scale_fill_brewer(palette = "Dark2")+
  ggtitle('Figure 6. Results Variability by Test Variable\n  and Belief that H is True, Team-Level Average') +
  theme(
...
fig5 <- ggplot(cri_team_combine, aes(x=pro_immigrant_cat_factor, y=AME_Zt, fill = iv_type2))+
  ...
  scale_x_discrete(limits = c("Low","Mid","High")) +
  ylab('Avg. Marginal Effect')+xlab('Avg. Pro-Immigration Affect by Researcher/Team')+
  ylim(-0.12,0.12)+
  coord_flip()+guides(fill = FALSE)+
  scale_colour_brewer(palette = "Dark2")+
  scale_fill_brewer(palette = "Dark2")+
  ggtitle('Figure 5. Results Variability by Test Variable\n  and Pro-Immigration Affect, Team-Level Average') +
  theme(
    axis.text=element_text(size=10),
    axis.title=element_text(size=12),
    plot.title=element_text(size=12, hjust=-0.5),
...
fig6 <- ggplot(cri_team_combine, aes(x=topic_cat_factor, y=AME_Zt, fill = iv_type2))+
  ...
  scale_x_discrete(limits = c("Low","Mid","High")) +
  ylab('Avg. Marginal Effect')+xlab('Topical Knowledge by Researcher/Team')+
  ylim(-0.12,0.12)+
  coord_flip()+guides(fill = FALSE)+
  scale_colour_brewer(palette = "Dark2")+
  scale_fill_brewer(palette = "Dark2")+
  ggtitle('Figure 6. Results Variability by Test Variable\n  and Topical Knowledge, Team-Level Average') +
  theme(
    axis.text=element_text(size=10),
    axis.title=element_text(size=12),
    plot.title=element_text(size=12, hjust=-0.5),
...
fig7 <- ggplot(cri_team_combine, aes(x=stat_cat_factor, y=AME_Zt, fill = iv_type2))+
  ...
  scale_x_discrete(limits = c("Low","Mid","High")) +
  ylab('Avg. Marginal Effect')+xlab('Statistical Skills by Researcher/Team')+
  ylim(-0.12,0.12)+
  coord_flip()+guides(fill = FALSE)+
  scale_colour_brewer(palette = "Dark2")+
  scale_fill_brewer(palette = "Dark2")+
  ggtitle('Figure 7. Results Variability by Test Variable\n  and Statistics Skills, Team-Level Average') +
  theme(
    axis.text=element_text(size=10),
    axis.title=element_text(size=12),
    plot.title=element_text(size=12, hjust=-0.5),
